...
const eslintConfig = [
  {
    ignores: [
      ...
      "convex/_generated/**",
      "coverage/**",
      // Generated by `sync-ai`, plus any agent worktrees living under it. Linting
      // a second checkout of this repo is how `ci:local` stops reproducing CI:
      // CI clones fresh and never sees these, so a violation in a stale worktree
      // fails the local gate and nothing else.
      ".claude/**",
    ],
  },
  {
